...
public class ExceptionHandlingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        {
            await HandleUnprocessableEntityExceptionAsync(context, ex);
        }
    ...
    /// <summary>
    /// Handles UnprocessableEntityException and returns a 422 Unprocessable Entity response.
    /// </summary>
    private static async Task HandleUnprocessableEntityExceptionAsync(
        HttpContext context,
    ...
    /// <summary>
    /// Handles InvalidOperationException and returns a 400 Bad Request response.
    /// Used for business logic validation errors that don't fit other categories.
    /// </summary>
