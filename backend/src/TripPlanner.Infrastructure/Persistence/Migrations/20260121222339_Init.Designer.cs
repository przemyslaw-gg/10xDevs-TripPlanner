...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripPlanner.Domain.Entities.Profile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("trip_attractions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_order_index_positive", "order_index > 0");
                        });
                });

            modelBuilder.Entity("TripPlanner.Domain.Entities.Attraction", b =>
                {
                    b.HasOne("TripPlanner.Domain.Entities.Profile", "CreatedByUser")
            ...
            modelBuilder.Entity("TripPlanner.Domain.Entities.Trip", b =>
                {
                    ...
                    b.HasOne("TripPlanner.Domain.Entities.Profile", "Owner")
                        .WithMany("Trips")
